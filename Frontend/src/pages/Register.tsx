...
export default function Register() {
    ...
    const handleRegister = async (e: React.FormEvent) => {
        ...
        if (!email.includes('@')) { setError('Correo electrónico inválido.'); return; }

        setLoading(true);
        try {
            await registerCtx({ full_name: fullName, email, password, role: 'estudiante' });
            navigate('/dashboard');
        } catch (err: any) {
            ...
            <div className="auth-panel">
                ...
                <form onSubmit={handleRegister} style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                    ...
                    <div className="form-group">
                        ...
                        <input type="email" placeholder="hola@ejemplo.com" value={email}
                    ...
                    {error && (
                        <p style={{
                            ...
                            borderRadius: '10px', fontSize: '0.875rem', margin: 0
                        }}>{error}</p>
                    )}
