-- ============================================================
-- Migration 005 - Tablas: evaluation_responses y response_answers
-- ============================================================
...
COMMENT ON COLUMN response_answers.answer  IS 'Texto libre: puede ser un numero de escala, opcion elegida o texto';
