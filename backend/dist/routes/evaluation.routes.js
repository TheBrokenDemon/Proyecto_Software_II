...
router.get('/', (req, res, next) => (0, evaluation_controller_1.listEvaluations)(req, res, next));
router.get('/history', (0, auth_middleware_1.authorize)('estudiante'), (req, res, next) => (0, evaluation_controller_1.myHistory)(req, res, next));
router.get('/:slug', (req, res, next) => (0, evaluation_controller_1.getEvaluation)(req, res, next));
...
], validate_middleware_1.handleValidationErrors, (req, res, next) => (0, evaluation_controller_1.submitResponses)(req, res, next));
