...
import {
    ...
    appointmentRequests, respondAppointmentRequest,
...
router.get('/appointment-requests', wrap(appointmentRequests));
router.patch('/appointment-requests/:id', wrap(respondAppointmentRequest));
